...
const deckOfCards = [
  ...
  { id: 4, name: 'Captain America', image: captainAmerica, selected: false },
  { id: 5, name: 'Captain Marvel', image: captainMarvel, selected: false },
  { id: 6, name: 'Doctor Doom', image: drDoom, selected: false },
  { id: 7, name: 'Doctor Octopus', image: drOctopus, selected: false },
  { id: 8, name: 'Hawkeye', image: hawkeye, selected: false },
  { id: 9, name: 'Hela', image: hela, selected: false },
  { id: 10, name: 'Hulk', image: hulk, selected: false },
