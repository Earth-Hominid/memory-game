...
const data = [
  ...
  { id: 5, name: 'Captain Marvel', image: captainMarvel },
  { id: 6, name: 'Doctor Doom', image: drDoom },
  { id: 7, name: 'Doctor Octopus', image: drOctopus },
  { id: 8, name: 'Hawkeye', image: hawkeye },
  { id: 9, name: 'Hela', image: hela },
  { id: 10, name: 'Hulk', image: hulk },
  { id: 11, name: 'Iron Man', image: ironman },
  { id: 12, name: 'Juggernaut', image: juggernaut },
  { id: 13, name: 'Red Hulk', image: redHulk },
  { id: 14, name: 'Spider-Man', image: spidermanTwo },
  { id: 15, name: 'Spider-Man', image: spiderman },
  { id: 16, name: 'Thor', image: thor },
  { id: 17, name: 'Thor', image: thorTwo },
  { id: 18, name: 'Venom', image: venom },
  { id: 19, name: 'Vision', image: vision },
  { id: 20, name: 'Wolverine', image: wolverine },
];
